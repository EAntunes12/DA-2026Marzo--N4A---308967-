...
public class DatosPrueba {
        ...
        private static void cargarJornadas()
                ...
                jornadaHoy = new Jornada(LocalDate.now());

                jornadaPasada = new Jornada(
                                LocalDate.now().minusWeeks(1));

                jornadaFutura = new Jornada(
        ...
        private static void cargarCarrerasHoy()
                        ...
                        ParticipacionNoValidaException,
                        ApuestaNoValidaException {
                ...
                // ABIERTA CON APUESTAS
                carrera3.abrir();
                generarApuestas(carrera3);
                ...
                jornadaHoy.agregarCarrera(carrera4);
                jornadaHoy.agregarCarrera(carrera5);
                jornadaHoy.agregarCarrera(carrera6);
                jornadaHoy.agregarCarrera(carrera7);
        }
        // ------------------------------------------
        // CARRERAS PASADAS
        // ------------------------------------------
        ...
        private static void agregarParticipantes(
                        Carrera carrera,
                        Caballo... caballos) throws ParticipacionNoValidaException {
